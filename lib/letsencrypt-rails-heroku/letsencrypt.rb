module Letsencrypt
  ...
  class Configuration
    ...
    def update_challenge(challenge_filename, challenge_file_content)
      acme_challenge_filename = challenge_filename
      acme_challenge_file_content = challenge_file_content
    end
