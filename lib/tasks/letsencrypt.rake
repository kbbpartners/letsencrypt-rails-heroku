...
namespace :letsencrypt do
  ...
  task :renew do
    ...
    domains.each_with_index do |domain, attempt_number|
      ...
      Letsencrypt.configuration.acme_challenge_filename = update_result['ACME_CHALLENGE_FILENAME']
      Letsencrypt.configuration.acme_challenge_file_content = update_result['ACME_CHALLENGE_FILENAME']
